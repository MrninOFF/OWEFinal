  ...
  <div class="col-sm-12 col-md-12">
   ...
   <div class="col-sm-12 col-md-6">
    ...
    <div class="row">
      ...
      <div class="form-group"><label>Start Fame:</label> 
      <input class="form-control"
      :value="startFame2"
      @input="updateValue('startFame2', $event.target.value)"></div>
      <div class="form-group"><label>End Fame:</label> 
      <input class="form-control"
      :value="endFame2"
      @input="updateValue('endFame2', $event.target.value)"></div>
...
export default {
  ...
  methods: {
    addAct() {
      this.newAct.startFame = this.startFame2;
      this.newAct.endFame = this.endFame2;
    ...
    updateValue: function(field, value) {
      ...
      if (isNaN(formattedValue) || !Number.isInteger(formattedValue)) {
        ...
        formattedValue = this[field];
      } else if (formattedValue <= 0 && field === "startFame2") {
        formattedValue = this[field];
      } else if (formattedValue <= 0 && field === "endFame2") {
        formattedValue = this[field];
      }
